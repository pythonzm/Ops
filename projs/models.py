...
class Project(models.Model):
    ...
    project_web = models.CharField(max_length=64, blank=True, null=True, verbose_name='项目网址')
    ...
    project_memo = models.TextField(blank=True, null=True, verbose_name='项目描述')
...
class Service(models.Model):
    ...
    service_assets = models.ManyToManyField('assets.Assets', verbose_name='提供服务的机器')
    service_memo = models.TextField(blank=True, null=True, verbose_name='服务描述')
