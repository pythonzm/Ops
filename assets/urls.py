...
urlpatterns = [
    ...
    path(r'docker_list/', views.docker_list, name='docker_list'),
    path(r'get_docker_list/', views.get_docker_list, name='get_docker_list'),
    path(r'add_base_asset/', views.add_base_asset, name='add_base_asset'),
    re_path(r'docker_ssh/', views.docker_ssh, name='docker_ssh'),
