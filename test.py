...
if __name__ == '__main__':
    resources = {
        "group1": {
            "hosts": [
                {"ip": "10.1.19.10", "port": "22", "username": "root", "password": "Aa123456!", "redis_port": "6379"},
                {"ip": "10.1.19.60", "port": "1715", "username": "root", "password": "123456"}],
            "vars": {"http_port": "80"}
        }
    }
    ans = ANSRunner(resources)
    ans.run_module(host_list=["10.1.19.10"], module_name='setup', module_args='')
